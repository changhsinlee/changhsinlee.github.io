...
[Click on this link to go to the section on "Font"](https://changhsinlee.com/pyderpuffgirls-ep7/#Font) and see how to select cells.

## Example code #2

To walk through all the buttons on the Home tab, I am going to use the following code, and replace the "styling code" part a the corresponding function.
...
According to the styles guide, I can set `cell.alignment` with the `Alignment` object:
